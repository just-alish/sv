...
const headerThemeBtn = document.querySelector<HTMLElement>('.themeCheckbox');
if ( headerThemeBtn instanceof HTMLElement ) {
  console.log(headerThemeBtn);
  console.log(typeof headerThemeBtn);
  addSpringTilt(headerThemeBtn);
}
