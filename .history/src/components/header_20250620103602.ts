  ...
  function createThemeBtn() {
    ...
    themeBtn.innerHTML = `
      <label for='themeCheckbox'>
        <div class='themeInsides'>dark</div>
        <div class='themeInsides'>
          <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212"><defs><style>.cls-1{fill:none;stroke:#fff;stroke-miterlimit:10;stroke-width:5px;}.cls-2{fill:#fff;}</style></defs><circle class="cls-1" cx="105.5" cy="106" r="53.5"/><rect class="cls-2" x="103.5" width="5" height="40"/><rect class="cls-2" x="103.5" y="172" width="5" height="40"/><rect class="cls-2" x="208.81" y="69.19" width="5" height="40" transform="translate(80.46 -167.3) rotate(45)"/><rect class="cls-2" x="87.19" y="190.81" width="5" height="40" transform="translate(130.84 -45.67) rotate(45)"/><rect class="cls-2" x="87.19" y="69.19" width="5" height="40" transform="translate(-81.3 45.54) rotate(-45)"/><rect class="cls-2" x="208.81" y="190.81" width="5" height="40" transform="translate(-131.67 167.16) rotate(-45)"/><rect class="cls-2" x="62" y="130" width="5" height="40" transform="translate(-130 170.5) rotate(-90)"/><rect class="cls-2" x="234" y="130" width="5" height="40" transform="translate(42 342.5) rotate(-90)"/></svg>
        </div>
      </label>
