...
export function createHeader() {
  function createLogo() {
    ...
    logo.innerHTML = `
      <svg id="svlayer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 187.05 106.86"><defs><style>.cls-sv-1,.cls-sv-2{fill:none;}.cls-sv-1{stroke:#000;stroke-miterlimit:10;stroke-width:5px;}</style></defs><g id="svbr"><path id="rightbr" class="cls-sv-1" d="M168.09,105.43a91,91,0,0,0,.28-104" transform="translate(0 -0.01)"/><path id="leftbr" class="cls-sv-1" d="M18.69,1.43a91,91,0,0,0,.27,104" transform="translate(0 -0.01)"/></g><g id="svlt"><path d="M68.87,79.43a28.31,28.31,0,0,1-13.45-3.1,17.38,17.38,0,0,1-8.25-8.9l4.3-2.9a14.49,14.49,0,0,0,6.45,7.75A22.06,22.06,0,0,0,69.27,75q6.6,0,10.35-2.6a8,8,0,0,0,3.75-6.9,7.51,7.51,0,0,0-1.85-5.05c-1.24-1.43-3.55-2.52-7-3.25l-11.7-2.5q-7.2-1.5-10.25-4.85A12.22,12.22,0,0,1,52,34.53a16.89,16.89,0,0,1,6.65-5.15,23.57,23.57,0,0,1,10-2q7.5,0,12.4,3a15.93,15.93,0,0,1,6.9,8.85l-4.2,2.7a12.41,12.41,0,0,0-5.55-7.7,18.47,18.47,0,0,0-9.55-2.4,19.81,19.81,0,0,0-7.35,1.25,11.65,11.65,0,0,0-4.9,3.4,7.6,7.6,0,0,0-1.75,5,7.86,7.86,0,0,0,2,5.25q2,2.35,7.1,3.45l12,2.6q7.09,1.5,9.9,4.55a10.79,10.79,0,0,1,2.8,7.55,12.89,12.89,0,0,1-2.4,7.8,15,15,0,0,1-6.8,5A27.7,27.7,0,0,1,68.87,79.43Z" transform="translate(0 -0.01)"/><path d="M135.37,28.43h5.3l-20.9,50h-5l-20.9-50h5.6l17.9,44.8Z" transform="translate(0 -0.01)"/></g><g id="svsmbr"><g id="leftsmbr"><path class="cls-sv-1" d="M32.85,11a74.13,74.13,0,0,0-13.2,42.4" transform="translate(0 -0.01)"/></g><g id="rightsmbr"><path class="cls-sv-2" d="M154.18,95.85a74.13,74.13,0,0,0,13.2-42.4" transform="translate(0 -0.01)"/></g></g></svg>
    `;
