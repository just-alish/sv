    ...
    themeBtn.innerHTML = `
      <label for='themeCheckbox'>
        <div class='themeInsides'>
          <svg id="moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42.94 42.94">
            <defs>
              <style>
                .cls-moon{fill:none;stroke:#ffffffd9;stroke-miterlimit:10;stroke-width:5px;}
              </style>
            </defs>
            <path class="cls-moon" d="M21.6,1.13a20.51,20.51,0,0,0-2.48.15A14.08,14.08,0,1,1,1.28,19.12a20.48,20.48,0,1,0,20.32-18Z" transform="translate(-0.13 -0.13)"/>
          </svg>
        </div>
        <div class='themeInsides'>
