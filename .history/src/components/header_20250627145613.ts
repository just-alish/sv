    ...
    themeBtn.innerHTML = `
      <label for='themeCheckbox'>
        <div class='themeInsides'>
          <svg id="moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 218 218">
            <defs>
              <style>
                .cls-strk{fill:none;stroke:#ffffffd9;stroke-miterlimit:10;stroke-width:10px;}
              </style>
            </defs>
            <path class="cls-1" d="M150,46a105.2,105.2,0,0,0-12.62.76,71.5,71.5,0,1,1-90.62,90.62A105.2,105.2,0,0,0,46,150,104,104,0,1,0,150,46Z" transform="translate(-41 -41)"/>	<path class="cls-1" d="M150,46a105.2,105.2,0,0,0-12.62.76,71.5,71.5,0,1,1-90.62,90.62A105.2,105.2,0,0,0,46,150,104,104,0,1,0,150,46Z" transform="translate(-41 -41)"/>
          </svg>
        </div>
        <div class='themeInsides'>
          <svg id="sun" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212">
            <defs>
              <style>
                .cls-sun-strk{fill:none;stroke:#1d1d1dd9;stroke-miterlimit:10;stroke-width:10px;}
                .cls-sun-fill{fill:#1d1d1dd9;}
              </style>
            </defs>
            <circle class="cls-sun-strk" cx="105.5" cy="106" r="53.5"/>
            <rect class="cls-sun-fill" x="103.5" width="10" height="40"/><rect class="cls-sun-fill" x="103.5" y="172" width="10" height="40"/>
            <rect class="cls-sun-fill" x="208.81" y="69.19" width="10" height="40" transform="translate(80.46 -167.3) rotate(45)"/>
            <rect class="cls-sun-fill" x="87.19" y="190.81" width="10" height="40" transform="translate(130.84 -45.67) rotate(45)"/>
            <rect class="cls-sun-fill" x="87.19" y="69.19" width="10" height="40" transform="translate(-81.3 45.54) rotate(-45)"/>
            <rect class="cls-sun-fill" x="208.81" y="190.81" width="10" height="40" transform="translate(-131.67 167.16) rotate(-45)"/>
            <rect class="cls-sun-fill" x="62" y="130" width="10" height="40" transform="translate(-130 170.5) rotate(-90)"/>
            <rect class="cls-sun-fill" x="234" y="130" width="10" height="40" transform="translate(42 342.5) rotate(-90)"/>
          </svg>
        </div>
      </label>
