      ...
      <label for='themeCheckbox'>
        <div class='themeInsides'>
          <svg id="moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 213 213">
            <defs>
              <style>
                .cls-stroke{fill:none;stroke:#fff;stroke-miterlimit:10;stroke-width:5px;}
              </style>
            </defs>
        ...
        <div class='themeInsides'>
          <svg id="sun" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212">
            <defs>
              <style>
                .cls-sun-strk{fill:none;stroke:#fff;stroke-miterlimit:10;stroke-width:5px;}
                .cls-sun-fill{fill:#fff;}
              </style>
            </defs>
