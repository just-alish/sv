      ...
      <label for='themeCheckbox'>
        <div class='themeInsides'>
          <svg id="moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 218 218">
            ...
            <path class="cls-strk" d="M150,46a105.2,105.2,0,0,0-12.62.76,71.5,71.5,0,1,1-90.62,90.62A105.2,105.2,0,0,0,46,150,104,104,0,1,0,150,46Z" transform="translate(-41 -41)"/>
          </svg>
        </div>
        <div class='themeInsides'>
          <svg id="sun" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212">
            <defs>
              <style>
                .cls-sun-1{fill:none;}.cls-sun-1,.cls-sun-2,.cls-sun-3{stroke:#000;stroke-miterlimit:10;}.cls-sun-1,.cls-sun-2{stroke-width:10px;}.cls-sun-3{stroke-width:5px;}
              </style>
            </defs>
            <circle class="cls-sun-1" cx="114" cy="114" r="52"/><circle class="cls-sun-2" cx="114" cy="10" r="5"/><circle class="cls-sun-2" cx="114" cy="218" r="5"/><circle class="cls-sun-2" cx="218" cy="114" r="5"/><circle class="cls-sun-2" cx="10" cy="114" r="5"/><circle class="cls-sun-2" cx="187.54" cy="40.46" r="5"/><circle class="cls-sun-2" cx="40.46" cy="187.54" r="5"/><circle class="cls-sun-2" cx="187.54" cy="187.54" r="5"/><circle class="cls-sun-2" cx="40.46" cy="40.46" r="5"/><circle class="cls-sun-3" cx="114" cy="39.12" r="3.6"/><circle class="cls-sun-3" cx="114" cy="188.88" r="3.6"/><circle class="cls-sun-3" cx="188.88" cy="114" r="3.6"/><circle class="cls-sun-3" cx="39.12" cy="114" r="3.6"/><circle class="cls-sun-3" cx="166.95" cy="61.05" r="3.6"/><circle class="cls-sun-3" cx="61.05" cy="166.95" r="3.6"/><circle class="cls-sun-3" cx="166.95" cy="166.95" r="3.6"/><circle class="cls-sun-3" cx="61.05" cy="61.05" r="3.6"/>
          </svg>
        </div>
      </label>
