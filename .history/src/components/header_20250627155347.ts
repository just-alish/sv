    ...
    themeBtn.innerHTML = `
      <label for='themeCheckbox'>
        <div class='themeInsides'>
          <svg id="moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 57.59 57.59">
            <defs>
              <style>
                .cls-strk{fill:none;stroke:#ffffffd9;stroke-miterlimit:10;stroke-width:10px;}
              </style>
            </defs>
            <path class="cls-strk" d="M28.81,2.51a26.14,26.14,0,0,0-3.19.19A18.08,18.08,0,1,1,2.7,25.61a28.44,28.44,0,0,0-.19,3.19A26.3,26.3,0,1,0,28.81,2.51Z" transform="translate(-0.01 -0.01)"/>
          </svg>
        </div>
        <div class='themeInsides'>
          <svg id="sun" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212">
            <defs>
              <style>
                .cls-sun-1{fill:none;stroke:#000;stroke-miterlimit:10;stroke-width:10px;}
              </style>
            </defs>
            <circle class="cls-sun-1" cx="78" cy="78" r="52"/><line class="cls-sun-1" x1="78" x2="78" y2="17.33"/><line class="cls-sun-1" x1="78" y1="138.67" x2="78" y2="156"/><line class="cls-sun-1" x1="133.15" y1="22.85" x2="120.9" y2="35.1"/><line class="cls-sun-1" x1="35.1" y1="120.9" x2="22.85" y2="133.15"/><line class="cls-sun-1" x1="133.15" y1="133.15" x2="120.9" y2="120.9"/><line class="cls-sun-1" x1="35.1" y1="35.1" x2="22.85" y2="22.85"/><line class="cls-sun-1" x1="156" y1="78" x2="138.67" y2="78"/><line class="cls-sun-1" x1="17.33" y1="78" y2="78"/>
          </svg>
        </div>
      </label>
