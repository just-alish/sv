      ...
      <label for='themeCheckbox'>
        <div class='themeInsides'>
          <svg id="moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 213 213">
            <defs>
              <style>
                .cls-strk{fill:none;stroke:#fff;stroke-miterlimit:10;stroke-width:7px;}
              </style>
            </defs>
        ...
        <div class='themeInsides'>
          <svg id="sun" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212">
            ...
            <rect class="cls-sun-fill" x="103.5" width="5" height="40"/><rect class="cls-sun-fill" x="103.5" y="172" width="8" height="40"/>
