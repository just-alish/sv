      ...
      <label for='themeCheckbox'>
        <div class='themeInsides'>
          <svg id="moon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 213 213">
            <defs>
              <style>
                .cls-strk{fill:none;stroke:#ffffffd9;stroke-miterlimit:10;stroke-width:5px;}
              </style>
            </defs>
        ...
        <div class='themeInsides'>
          <svg id="sun" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212">
            ...
            <rect class="cls-sun-fill" x="208.81" y="69.19" width="10" height="35" transform="translate(80.46 -167.3) rotate(45)"/>
            <rect class="cls-sun-fill" x="87.19" y="190.81" width="10" height="35" transform="translate(130.84 -45.67) rotate(45)"/>
