export function addSpringTilt(element: HTMLElement, {
    ...
    const updateTransform = (e: MouseEvent) => {
        ...
        animationFrameId = requestAnimationFrame(() => {
            ...
            // Calculate default rotation factor inside mouseenter to avoid recalculating every frame
            const effectiveMaxRotateW = maxRotateW ?? (64 * 20 / rect.width);
            const effectiveMaxRotateH = maxRotateH ?? (64 * 20 / rect.height);
    ...
    const onMouseEnter = (e: MouseEvent) => {
        ...
        updateTransform(e); // Apply initial transform immediately
    };
    ...
    return {
        destroy() {
            ...
            element.removeEventListener('mousemove', updateTransform);
